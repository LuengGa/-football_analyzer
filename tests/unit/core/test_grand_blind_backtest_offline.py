...
try:
    from src.calculations.backtest_engine import BacktestSandbox
except ImportError:
    # Fallback: BacktestSandbox is being developed; skip tests that need it
    import pytest

    BacktestSandbox = None  # type: ignore
    pytest.skip("BacktestSandbox not available (in development)", allow_module_level=True)
