...
# 引入我们写好的硬核本地工具
from src.calculations.quant.hardcore_quant_math import HardcoreQuantMath
from src.calculations.lottery.chinese_lottery_official_calc import ChineseLotteryOfficialCalculator
from src.agents.grandmaster_router import GrandmasterRouter
from src.core.agentic_os.hallucination_guard import HallucinationGuard
from src.core.mcp_discoverer import MCPToolDiscoverer
from src.core.agentic_os.hippocampus import HippocampusMemory
from src.tools.execution.betting_ledger import BettingLedger
from src.calculations.quant.environment_analyzer import EnvironmentAnalyzer
...
# news_listener = SocialNewsListener()  # 模块不存在，暂注释
...
def verify_risk(lottery_type: str, play_type: str, proposed_stake_percent: float, true_prob: float, official_odds: float) -> dict:
    ...
    """
    from src.calculations.quant.smart_bet_selector import SmartBetSelector
...
tools = [calculate_true_probs_for_all_markets, verify_risk, check_balance, execute_ticket_route, fetch_match_environment]
