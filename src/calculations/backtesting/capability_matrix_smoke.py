...
def run_capability_smoke_tests(*, offline: bool = True, workspace_root: Optional[Path] = None) -> Dict[str, Any]:
    ...
    if not jingcai_sp_html:
        ...
        try:
            from src.tools.odds.domestic_500_jczq_sp import parse_500_jczq_trade_sp_html
    ...
    if not live_html:
        ...
        try:
            from src.tools.odds.domestic_500_live_state import parse_500_live_detail_html
    ...
    if not results_html:
        ...
        try:
            from src.tools.odds.domestic_500_results import parse_500_trade_results_html
    ...
    try:
        from src.calculations.lottery.lottery_router import LotteryRouter
    ...
    if not beidan_html:
        ...
        try:
            from src.tools.odds.domestic_500_beidan_sp import parse_500_beidan_sp_html
